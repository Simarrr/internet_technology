  ...
  return (
    <div className={'App'}>
      <header className={'main_header'}>
        ...
        <ItemList setItemList={setItemList} setSecondModalVisible={setSecondModalVisible} itemList={itemList} setItemId={setSecondId} items={itemList} modalVisible={modalVisible} setModalVisible={setModalVisible}/>
        ...
        <Modal visible={secondModalVisible} setVisible={setSecondModalVisible}>
            <FormAddItem setItemList={setItemList} itemId={secondId} itemList={itemList} visible={secondModalVisible} setModalVisible={setSecondModalVisible}/>
        </Modal>
    </div>
  );
}
