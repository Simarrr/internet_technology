...
const Item = (props) => {
    ...
    return (
        <div className={classes.tmTasklist}>
            ...
            <div className={classes.itemType}>{props.body.boat_type}</div>
            <SecondItemList setSecondItemList={props.setSecondItemList} itemList={props.itemList} setItems={setSecondItems} id={props.id} setSecondModalVisible={props.setSecondModalVisible} setItemId={props.setItemId} items={secondItems}/>
        </div>
    );
};
