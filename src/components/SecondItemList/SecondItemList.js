...
const SecondItemList = (props) => {
    ...
    return (
        <div className={classes.list}>
            {props.items.map(item => <SecondItem setFirstItemList={props.setSecondItemList} itemList={props.itemList} firstId={props.id} setItems={props.setItems} id={item.id} body={item}/>)}
